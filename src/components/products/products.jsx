    ...
    <div className="mt-14 mb-12">
      <div  className="container">
        ...
        <div className='text-center mb-10 max-w-[600px] mx-auto' >
            <p  data-aos="fade-up" className='text-xl text-amber-400'>Top Selling products for you</p>
            <h1 data-aos="fade-up" className='text-4xl font-bold'>Products</h1>
            <p  data-aos="fade-up" className='text-xl text-gray-400'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit asperiores modi sit asperiores modi.</p>
        </div>
